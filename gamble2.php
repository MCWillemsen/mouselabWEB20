...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
        ...
        <div class="w3-white w3-container">
            ...
            <h1>Introduction</h1>
            <p>In this example, You decide between two gambles, that each have three outcomes with three probabilities. The rows are randomized and the order of the options is determin. This version uses the second set (dynSet2) that flips the rows and cols via layout: attributeCol and changes the styling of the cells compared to the previous set </p>
