...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
        ...
        <div class="w3-white w3-container">
            ...
            <h1>Introduction</h1>
            <p>In this example, You get to decide between two or three TVs depending on the condition as determined by condnum  (third order has 3). Order of options is determined by condnum and rows are randomly ordered.</p>
