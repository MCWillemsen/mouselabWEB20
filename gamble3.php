...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
        ...
        <div class="w3-white w3-container">
            ...
            <h1>Introduction</h1>
            <p>In this example, You decide between two gambles, that each have three outcomes with three probabilities. The rows are randomized and the order of the options is determined. This version uses the third set (dynSet3) that replaces the option labels (option A and option B) for fixed labels (gamble X and gamble Y) op the options and buttons that stay in their current position, whatever actual option is behind it (so Gamble X can be option A or B depending on the actual order).</p>
        ...
        <script type="text/javascript">
			...
			generateTrial("json_files/gamble.json", "dynSet3", o);
